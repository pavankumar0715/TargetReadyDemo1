package com.targetready.bankService.config;
...
public class KafkaConsumerConfig {
    ...
    public ConsumerFactory<String, Object> consumerFactory(KafkaTracing kafkaTracing) {
        ...
        configProps.put(JsonDeserializer.VALUE_DEFAULT_TYPE, Payment.class.getName());
        DefaultKafkaConsumerFactory<String, Object> factory = new DefaultKafkaConsumerFactory<>(configProps);
        factory.addPostProcessor(kafkaTracing::consumer);
        return factory;
    }
